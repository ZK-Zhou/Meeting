...
\end{figure}
 ...
 \noindent 已知数值的变量有：$a_j^{(l)}, x_i, y_i, W_{jk}^{(l)}$\\
 设激活函数为 logistic sigmoid函数，用$\sigma(x)$表示\\
    \begin{align*}
    \sigma'(z_j^l) = \frac {\exp^x}{\left(1+\exp^x\right)^2} = \frac{1}{\left(1+\exp^x\right)} \left( 1-\frac{1}{\left(1+\exp^x\right)}\right) = a_i^l\left(1-a_i^l\right)
    \end{align*}
    那么第三层权值参数的梯度计算为：\\
    \begin{align*}
    ...
    \begin{align*}
     \frac {\partial{J(W,b;x^i,y^i)}}{\partial W_{11}^{(3)}} = \delta_1^{(3)} \cdot a_1^2 
     = \frac{\partial{J}}{\partial{{a_{1}}^{(3)}}} \cdot \frac{\partial{{a_{1}}^{(3)}}}{\partial{{z_1}^{(3)}}} \cdot a_1^2
    = \left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right)\cdot {a_{1}}^{(2)}
    \end{align*}
    
    \begin{align*}
     \frac{\partial{J(W,b)}}{\partial{{W_{11}}^{(3)}}} = \left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right)\cdot {a_{1}}^{(2)} + \lambda {W_{11}}^{(3)}
    \end{align*}
 
 同理： \\
 $$ \frac{\partial{J(W,b)}}{\partial{{W_{12}}^{(3)}}} = \left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right)\cdot {a_{2}}^{(2)} + \lambda {W_{12}}^{(3)}$$
 $$ \frac{\partial{J(W,b)}}{\partial{{W_{13}}^{(3)}}} = ({a_{1}}^{(3)} - y^i) \cdot {a_{1}}^{(3)}(1-{a_{1}}^{(3)})\cdot {a_{3}}^{(2)} + \lambda {W_{13}}^{(3)}$$
第二层权值参数： \\
\begin{align*}
\frac{\partial{J(W,b)}}{\partial{{W_{11}}^{(2)}}} = \left[\frac{1}{m}\sum_1^m\frac{\partial{J(W,b;x^i,y^i)}}{W_{11}^{(2)}}\right] + \lambda {W_{11}}^{(3)}
 = {W_{11}}^{(3)}\delta_1^{(3)} \cdot {a_{1}}^{(2)}\left(1-{a_{1}}^{(2)}\right) \cdot x_1 \\
 = {W_{11}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{1}}^{(2)}\left(1-{a_{1}}^{(2)}\right) \cdot x_1 + \lambda {W_{11}}^{(2)}
\end{align*}

同理：
$$\frac{\partial{J(W,b)}}{\partial{{W_{21}}^{(2)}}} = {W_{12}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{2}}^{(2)}\left(1-{a_{2}}^{(2)}\right) \cdot x_1 + \lambda {W_{21}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{31}}^{(2)}}} = {W_{13}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{3}}^{(2)}\left(1-{a_{3}}^{(2)}\right) \cdot x_1 + \lambda {W_{31}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{12}}^{(2)}}} = {W_{11}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{1}}^{(2)}\left(1-{a_{1}}^{(2)}\right) \cdot x_2 + \lambda {W_{12}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{22}}^{(2)}}} = {W_{12}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{2}}^{(2)}\left(1-{a_{2}}^{(2)}\right) \cdot x_2 + \lambda {W_{22}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{32}}^{(2)}}} = {W_{13}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{3}}^{(2)}\left(1-{a_{3}}^{(2)}\right) \cdot x_2 + \lambda {W_{32}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{13}}^{(2)}}} = {W_{11}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{1}}^{(2)}\left(1-{a_{1}}^{(2)}\right) \cdot x_3 + \lambda {W_{13}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{23}}^{(2)}}} = {W_{12}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{2}}^{(2)}\left(1-{a_{2}}^{(2)}\right) \cdot x_3 + \lambda {W_{23}}^{(2)}$$
$$\frac{\partial{J(W,b)}}{\partial{{W_{33}}^{(2)}}} = {W_{13}}^{(3)}\left({a_{1}}^{(3)} - y^i\right) \cdot {a_{1}}^{(3)}\left(1-{a_{1}}^{(3)}\right) \cdot {a_{3}}^{(2)}\left(1-{a_{3}}^{(2)}\right) \cdot x_3 + \lambda {W_{33}}^{(2)}$$
